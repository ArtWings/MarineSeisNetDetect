...
pathToDir = 'F:\100 Hz november 2016 632 extra\';
list = dir(pathToDir);

pathToDirOfDetectionList = 'F:\100 Hz november 2016 632\filtered\Channel2\fig\! Earthquakes\';
...
for kkkkk = 3:1:length(listOfDetectionList)
    ...
    FileInitTimeString = listOfDetectionList(kkkkk).name(15:33);
    DetectSampleBegin = findstr(listOfDetectionList(kkkkk).name, '_sample_') + 8;
    DetectSampleEnd = findstr(listOfDetectionList(kkkkk).name, '_time_') - 1;
    DetectSample = str2num(listOfDetectionList(kkkkk).name(DetectSampleBegin:DetectSampleEnd));
